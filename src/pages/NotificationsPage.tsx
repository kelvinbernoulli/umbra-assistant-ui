    ...
    <div className="page">
      <div className="page-intro page-intro--row">
        <div>
          ...
          <h1>Notifications</h1>
          <p className="page-intro__copy">Updates from your Umbra workspace.</p>
        </div>
        <Link className="button button--outline" to="/settings/notifications">
      ...
      <section className="timeline-feed">
        <div className="empty-state">
          ...
          <span>
            Notification delivery hasn’t been connected. Updates will appear
